...
| **Originality & relevance (10)** — an agent a self-custody user would run unattended | A disciplined micro-capital spot trader with a survival constitution and a kill-switch reachable from a phone. | `/bsc/ops`, `KillSwitch` |
